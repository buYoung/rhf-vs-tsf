...
export interface SimpleRHFTopManagedProps {
...
function SimpleRHFTopManagedInner({ defaultValues, onReady }: SimpleRHFTopManagedProps, _ref: React.Ref<unknown>) {
...
const SimpleRHFTopManaged = forwardRef(SimpleRHFTopManagedInner);
export default SimpleRHFTopManaged;
