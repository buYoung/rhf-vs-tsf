...
function makeSectionA(): SectionAValues {
    ...
    return {
        ...
        gender: faker.helpers.arrayElement(genders as unknown as string[] as any),
        contactMethod: faker.helpers.arrayElement(contactMethods as unknown as string[] as any) as any,
        website: faker.internet.url(),
        interests: pickInterests,
        newsletter: faker.datatype.boolean(),
        country: faker.helpers.arrayElement(countries as unknown as string[]),
...
function makeSectionB(): SectionBValues {
    ...
    return {
        ...
        workPhone: faker.phone.number('+1-###-###-####'),
        officeLocation: faker.helpers.arrayElement(countries as unknown as string[]),
